...
namespace Rayones.Infrastructure.Services
{
    public class UriService : IUriService
    {
        ...
        Uri IUriService.GetAcabadosPaginationUri(AcabadosQueryFilter filter, string actionUrl)
        {
            string baseUrl = $"{_baseUri}{actionUrl}";
            return new Uri(baseUrl);
        }
        Uri IUriService.GetEstadosPaginationUri(EstadosQueryFilter filter, string actionUrl)
        {
            string baseUrl = $"{_baseUri}{actionUrl}";
            return new Uri(baseUrl);
        }
